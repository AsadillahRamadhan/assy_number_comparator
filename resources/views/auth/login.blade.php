...
<html lang="en">
  ...
  <body class="h-100">
              ...
              <div class="sw-lg-50 px-5">
                ...
                <div>
                  <form id="loginForm" class="tooltip-end-bottom" action="{{ route('login') }}" method="POST">
                    ...
                    <button type="submit" onclick="document.querySelector('#loginForm').submit()" class="btn btn-lg btn-primary">Login</button>
                  </form>
                </div>
              </div>
            </div>
    ...
    <script src="{{ asset('/template/Source/Html/acorn-html-classic-dashboard/src/js/vendor/jquery.validate/jquery.validate.min.js') }}"></script>

    <script src="{{ asset('/template/Source/Html/acorn-html-classic-dashboard/src/js/vendor/jquery.validate/additional-methods.min.js') }}"></script>
    ...
    <script src="{{ asset('/template/Source/Html/acorn-html-classic-dashboard/src/js/pages/auth.login.js') }}"></script>
