...
<html lang="en" data-footer="true">
  <head>
    ...
    <link rel="stylesheet" href="{{ asset('/template/Source/Html/acorn-html-classic-dashboard/src/font/CS-Interface/style.css') }}" />
    <!-- Font Tags End -->
    <!-- Vendor Styles Start -->
    <link rel="stylesheet" href="{{ asset('/template/Source/Html/acorn-html-classic-dashboard/src/css/vendor/bootstrap.min.css') }}" />
    <link rel="stylesheet" href="{{ asset('/template/Source/Html/acorn-html-classic-dashboard/src/css/vendor/OverlayScrollbars.min.css') }}" />

    <link rel="stylesheet" href="{{ asset('/template/Source/Html/acorn-html-classic-dashboard/src/css/vendor/glide.core.min.css') }}" />

    <link rel="stylesheet" href="{{ asset('/template/Source/Html/acorn-html-classic-dashboard/src/css/vendor/introjs.min.css') }}" />

    <link rel="stylesheet" href="{{ asset('/template/Source/Html/acorn-html-classic-dashboard/src/css/vendor/select2.min.css') }}" />

    <link rel="stylesheet" href="{{ asset('/template/Source/Html/acorn-html-classic-dashboard/src/css/vendor/select2-bootstrap4.min.css') }}" />

    <link rel="stylesheet" href="{{ asset('/template/Source/Html/acorn-html-classic-dashboard/src/css/vendor/plyr.css') }}" />

    <!-- Vendor Styles End -->
    <!-- Template Base Styles Start -->
    <link rel="stylesheet" href="{{ asset('/template/Source/Html/acorn-html-classic-dashboard/src/css/styles.css') }}" />
    <!-- Template Base Styles End -->

    <link rel="stylesheet" href="{{ asset('/template/Source/Html/acorn-html-classic-dashboard/src/css/main.css') }}" />
    <script src="{{ asset('/template/Source/Html/acorn-html-classic-dashboard/src/js/base/loader.js') }}"></script>
  </head>
  ...
  <body>
    ...
    <script src="{{ asset('/template/Source/Html/acorn-html-classic-dashboard/src/js/vendor/jquery-3.5.1.min.js') }}"></script>
    <script src="{{ asset('/datatables/jquery.dataTables.min.js') }}"></script>
    <script src="{{ asset('/datatables/dataTables.bootstrap.min.js') }}"></script>
    <script src="{{ asset('/template/Source/Html/acorn-html-classic-dashboard/src/js/vendor/bootstrap.bundle.min.js') }}"></script>
    <script src="{{ asset('/template/Source/Html/acorn-html-classic-dashboard/src/js/vendor/OverlayScrollbars.min.js') }}"></script>
    <script src="{{ asset('/template/Source/Html/acorn-html-classic-dashboard/src/js/vendor/autoComplete.min.js') }}"></script>
    <script src="{{ asset('/template/Source/Html/acorn-html-classic-dashboard/src/js/vendor/clamp.min.js') }}"></script>

    <script src="{{ asset('/template/Source/Html/acorn-html-classic-dashboard/src/icon/acorn-icons.js') }}"></script>
    <script src="{{ asset('/template/Source/Html/acorn-html-classic-dashboard/src/icon/acorn-icons-interface.js') }}"></script>

    <script src="{{ asset('/template/Source/Html/acorn-html-classic-dashboard/src/js/vendor/Chart.bundle.min.js') }}"></script>

    <script src="{{ asset('/template/Source/Html/acorn-html-classic-dashboard/src/js/vendor/chartjs-plugin-datalabels.js') }}"></script>

    <script src="{{ asset('/template/Source/Html/acorn-html-classic-dashboard/src/js/vendor/chartjs-plugin-rounded-bar.min.js') }}"></script>

    <script src="{{ asset('/template/Source/Html/acorn-html-classic-dashboard/src/js/vendor/glide.min.js') }}"></script>

    <script src="{{ asset('/template/Source/Html/acorn-html-classic-dashboard/src/js/vendor/intro.min.js') }}"></script>

    <script src="{{ asset('/template/Source/Html/acorn-html-classic-dashboard/src/js/vendor/select2.full.min.js') }}"></script>

    <script src="{{ asset('/template/Source/Html/acorn-html-classic-dashboard/src/js/vendor/plyr.min.js') }}"></script>

    <!-- Vendor Scripts End -->

    <!-- Template Base Scripts Start -->
    <script src="{{ asset('/template/Source/Html/acorn-html-classic-dashboard/src/js/base/helpers.js') }}"></script>
    <script src="{{ asset('/template/Source/Html/acorn-html-classic-dashboard/src/js/base/globals.js') }}"></script>
    <script src="{{ asset('/template/Source/Html/acorn-html-classic-dashboard/src/js/base/nav.js') }}"></script>
    <script src="{{ asset('/template/Source/Html/acorn-html-classic-dashboard/src/js/base/search.js') }}"></script>
    <script src="{{ asset('/template/Source/Html/acorn-html-classic-dashboard/src/js/base/settings.js') }}"></script>
    <!-- Template Base Scripts End -->
    <!-- Page Specific Scripts Start -->

    <script src="{{ asset('/template/Source/Html/acorn-html-classic-dashboard/src/js/cs/glide.custom.js') }}"></script>

    <script src="{{ asset('/template/Source/Html/acorn-html-classic-dashboard/src/js/cs/charts.extend.js') }}"></script>

    <script src="{{ asset('/template/Source/Html/acorn-html-classic-dashboard/src/js/pages/dashboard.default.js') }}"></script>

    <script src="{{ asset('/template/Source/Html/acorn-html-classic-dashboard/src/js/common.js') }}"></script>
    <script src="{{ asset('/template/Source/Html/acorn-html-classic-dashboard/src/js/scripts.js') }}"></script>
